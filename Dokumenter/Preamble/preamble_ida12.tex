\documentclass[a4paper,11pt,fleqn,dvipsnames,oneside,openright]{memoir} 	% Openright åbner kapitler på højresider (oneside eller openany begge)
...
% ¤¤ Så en side kan vises i landscape
\usepackage{rotating}
...
\usepackage{tabularx}						% Giver mulighed for advancerede tabeller
...
%\textbf{Date: } 09-02-2015	\tn
%\multicolumn{2}{l}{\textbf{Underskrift: }\line(1,0){340}} %Linje til underskrift
\end{tabular}
}
...
\textbf{Name: } #1		&\textbf{Mail: } #2	\tn
\textbf{Date: } 09-02-2015	\tn
%\multicolumn{1}{l}{\textbf{Underskrift: }\line(1,0){340}} %Linje til underskrift
\end{tabular}
}
